    ...
    <AnimatePresence>
      {show && (
        <>
          ...
          />
          <motion.div
            className="absolute top-0 left-0 w-full h-full flex items-center justify-center pointer-events-none z-50 px-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            >
              ...
              {text.split(' ').map((word, wordIndex) => (
                <div key={wordIndex} className="whitespace-nowrap mr-4">
